...
# Unit tests for SwaggerClient::EmployeeGroupingsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeeGroupingsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::EmployeeGroupingsApi.new
  end
  ...
  describe 'test an instance of EmployeeGroupingsApi' do
    it 'should create an instance of EmployeeGroupingsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::EmployeeGroupingsApi)
    end
  end

  # unit tests for v1_employee_groupings_archive_get
  ...
  describe 'v1_employee_groupings_archive_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_employee_groupings_get
  ...
  # @option opts [Array<String>] :filter This parameter can be used to filter the response. Each item of the list is a filter and must match the following pattern: &#x60;FIELD OPERATOR VALUE&#x60;. Where &#x60;FIELD&#x60; is the name of the field, &#x60;OPERATOR&#x60; is on of the filter methods listed below and &#x60;VALUE&#x60; is the given value that will be compared with the value of the respective field using the selected filter method.  ### Available filter methods  Method | Function  - | -   &#x3D; | all values that match exactly the given value  &lt;&gt; | all values that don&#39;t match the given value  &gt; | all values that are greater than the given value  &lt; | all values that are smaller than the given value  in | all values that are in the given value (where the given value must be a comma separated list)   It is strictly recommended to use this parameter in every request as it will reduce data traffic and can reduce the response time significantly.
  # @return [Array<EmployeeGrouping>]
  describe 'v1_employee_groupings_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_employee_groupings_id_delete
  # Deletes the grouping given by ID.
  # 
  # @param id The ID of the resource
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'v1_employee_groupings_id_delete test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_employee_groupings_id_get
  ...
  describe 'v1_employee_groupings_id_get test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_employee_groupings_id_put
  ...
  # @return [nil]
  describe 'v1_employee_groupings_id_put test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for v1_employee_groupings_post
  # Adds a new employee grouping.
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [EmployeeGrouping] :grouping The grouping to be added.
  # @return [nil]
  describe 'v1_employee_groupings_post test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
