...
module SwaggerClient
  # An operation as per [RFC 6902](https://tools.ietf.org/html/rfc6902), which can be used to update only parts of a resource.
  class PatchOperation
    # The operation to be performed (only `replace` is supported).
    attr_accessor :op

    # Path to the property to which the operations will be applied to.
    attr_accessor :path

    # The value to be used within the operations.
    attr_accessor :value

    # Not used yet, because replace operation does not need it.
    attr_accessor :from
