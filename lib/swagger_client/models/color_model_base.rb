...
module SwaggerClient
  # Base model definition for models that have a foreground color and a background color.
  class ColorModelBase
    ...
    def hash
      [foreground_color_html, background_color_html].hash
    end
