...
module SwaggerClient
  # Model base definition for models that represent a grouping.
  class GroupingModelBase
    ...
    def hash
      [auto_id, name, foreground_color_html, background_color_html, id, items].hash
    end
