...
module SwaggerClient
  ...
  class Customer
    ...
    # Part of the adress like street.
    attr_accessor :address1

    # Second part of the adress like street.
    ...
    def list_invalid_properties
      ...
      if !@zip_code.nil? && @zip_code.to_s.length > 255
        invalid_properties.push("invalid value for 'zip_code', the character length must be smaller than or equal to 255.")
      end
      ...
      if !@province.nil? && @province.to_s.length > 255
        invalid_properties.push("invalid value for 'province', the character length must be smaller than or equal to 255.")
      end

      if !@hint.nil? && @hint.to_s.length > 255
        invalid_properties.push("invalid value for 'hint', the character length must be smaller than or equal to 255.")
      end
    ...
    def valid?
      ...
      return false if !@zip_code.nil? && @zip_code.to_s.length > 255
      return false if !@country.nil? && @country.to_s.length > 255
      return false if !@province.nil? && @province.to_s.length > 255
      return false if !@hint.nil? && @hint.to_s.length > 255
      return true
    end
    ...
    def zip_code=(zip_code)
      ...
      if !zip_code.nil? && zip_code.to_s.length > 255
        fail ArgumentError, "invalid value for 'zip_code', the character length must be smaller than or equal to 255."
      end
    ...
    def province=(province)
      ...
      if !province.nil? && province.to_s.length > 255
        fail ArgumentError, "invalid value for 'province', the character length must be smaller than or equal to 255."
      end
    ...
    def hint=(hint)
      ...
      if !hint.nil? && hint.to_s.length > 255
        fail ArgumentError, "invalid value for 'hint', the character length must be smaller than or equal to 255."
      end
    ...
    def hash
      [id, name, short_name, foreground_color_html, background_color_html, key_values, groupings, auto_id, address1, address2, city, zip_code, country, province, hint].hash
    end
