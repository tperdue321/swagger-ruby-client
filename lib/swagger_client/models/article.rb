...
module SwaggerClient
  ...
  class Article
    ...
    # Height in millimeter (mm).
    attr_accessor :height

    # Width in millimeter (mm).
    attr_accessor :width

    # Preferred stacking height (items per stack) that might be used by folding machines or operators.
    attr_accessor :stacking_height

    # Textual description of the size (e.g., S, M, Large, 10x50)
    attr_accessor :size

    # Weight in gram (g).
    attr_accessor :weight

    # Textual description of the color (e.g., red, green, blue).
    attr_accessor :color
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stackingHeight')
        self.stacking_height = attributes[:'stackingHeight']
      end
    ...
    def list_invalid_properties
      ...
      if !@size.nil? && @size.to_s.length > 50
    ...
    def valid?
      ...
      return false if !@size.nil? && @size.to_s.length > 50
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          height == o.height &&
          width == o.width &&
          stacking_height == o.stacking_height &&
          size == o.size &&
          weight == o.weight &&
          color == o.color
    end
    ...
    def hash
      [id, name, short_name, foreground_color_html, background_color_html, key_values, groupings, auto_id, length, height, width, stacking_height, size, weight, color].hash
    end
