...
module SwaggerClient
  ...
  class Employee
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'chipId')
        self.chip_id = attributes[:'chipId']
      end
    ...
    def list_invalid_properties
      ...
      if !@chip_id.nil? && @chip_id.to_s.length > 11
        invalid_properties.push("invalid value for 'chip_id', the character length must be smaller than or equal to 11.")
      end
    ...
    def valid?
      ...
      return false if !@chip_id.nil? && @chip_id.to_s.length > 11
      return true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] chip_id Value to be assigned
    def chip_id=(chip_id)

      if !chip_id.nil? && chip_id.to_s.length > 11
        fail ArgumentError, "invalid value for 'chip_id', the character length must be smaller than or equal to 11."
      end
    ...
    def hash
      [foreground_color_html, background_color_html, key_values, groupings, auto_id, id, first_name, last_name, chip_id].hash
    end
