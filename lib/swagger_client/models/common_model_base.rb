...
module SwaggerClient
  # Base model definition for models that represent a location or location type.
  class CommonModelBase
    ...
    def hash
      [name, short_name, foreground_color_html, background_color_html, key_values, groupings, id, auto_id].hash
    end
