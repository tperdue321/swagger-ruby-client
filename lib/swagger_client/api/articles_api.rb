...
module SwaggerClient
  class ArticlesApi
    ...
    def v1_articles_archive_get(opts = {})
      data, _status_code, _headers = v1_articles_archive_get_with_http_info(opts)
      return data
    end
    ...
    def v1_articles_archive_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_archive_get ..."
      end
      # resource path
      local_var_path = "/v1/articles/archive"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_archive_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [Array<String>] :filter This parameter can be used to filter the response. Each item of the list is a filter and must match the following pattern: &#x60;FIELD OPERATOR VALUE&#x60;. Where &#x60;FIELD&#x60; is the name of the field, &#x60;OPERATOR&#x60; is on of the filter methods listed below and &#x60;VALUE&#x60; is the given value that will be compared with the value of the respective field using the selected filter method.  ### Available filter methods  Method | Function  - | -   &#x3D; | all values that match exactly the given value  &lt;&gt; | all values that don&#39;t match the given value  &gt; | all values that are greater than the given value  &lt; | all values that are smaller than the given value  in | all values that are in the given value (where the given value must be a comma separated list)   It is strictly recommended to use this parameter in every request as it will reduce data traffic and can reduce the response time significantly.
    # @return [Array<(Array<Article>, Fixnum, Hash)>] Array<Article> data, response status code and response headers
    def v1_articles_get_with_http_info(opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v1_articles_id_delete(id, opts = {})
      v1_articles_id_delete_with_http_info(id, opts)
      return nil
    end
    ...
    def v1_articles_id_delete_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_id_delete ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ArticlesApi.v1_articles_id_delete"
      end
      # resource path
      local_var_path = "/v1/articles/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_id_delete\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [Array<String>] :field Influences the structure of the response&#39;s schema. Each item of the list must be the name of a field. Fields that are not mentioned will not be returned. The order of the items will be respected. If this parameter is not set the response will contain all field as described in the response&#39;s schema.    It is strictly recommended to use this parameter in every request as it will reduce data traffic and can reduce the response time significantly.
    # @return [Article]
    def v1_articles_id_get(id, opts = {})
      data, _status_code, _headers = v1_articles_id_get_with_http_info(id, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Array<String>] :field Influences the structure of the response&#39;s schema. Each item of the list must be the name of a field. Fields that are not mentioned will not be returned. The order of the items will be respected. If this parameter is not set the response will contain all field as described in the response&#39;s schema.    It is strictly recommended to use this parameter in every request as it will reduce data traffic and can reduce the response time significantly.
    # @return [Array<(Article, Fixnum, Hash)>] Article data, response status code and response headers
    def v1_articles_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_id_get ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ArticlesApi.v1_articles_id_get"
      end
      # resource path
      local_var_path = "/v1/articles/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Article')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v1_articles_id_patch(id, json_patch_document, opts = {})
      v1_articles_id_patch_with_http_info(id, json_patch_document, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_articles_id_patch_with_http_info(id, json_patch_document, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_id_patch ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ArticlesApi.v1_articles_id_patch"
      end
      ...
      if @api_client.config.client_side_validation && json_patch_document.nil?
        fail ArgumentError, "Missing the required parameter 'json_patch_document' when calling ArticlesApi.v1_articles_id_patch"
      end
      # resource path
      local_var_path = "/v1/articles/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_id_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id The ID of the resource
    # @param [Hash] opts the optional parameters
    # @option opts [Article] :article The article that shall be updated.
    # @return [nil]
    def v1_articles_id_put(id, opts = {})
      v1_articles_id_put_with_http_info(id, opts)
      return nil
    end
    ...
    # @option opts [Article] :article The article that shall be updated.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_articles_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_id_put ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ArticlesApi.v1_articles_id_put"
      end
      # resource path
      local_var_path = "/v1/articles/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'article'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @option opts [Article] :article The article that shall be added.
    # @return [nil]
    def v1_articles_post(opts = {})
      v1_articles_post_with_http_info(opts)
      return nil
    end
    ...
    # @option opts [Article] :article The article that shall be added.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_articles_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: ArticlesApi.v1_articles_post ..."
      end
      # resource path
      local_var_path = "/v1/articles"
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ArticlesApi#v1_articles_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
