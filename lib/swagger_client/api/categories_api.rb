...
module SwaggerClient
  class CategoriesApi
    ...
    def v1_categories_archive_get(opts = {})
      data, _status_code, _headers = v1_categories_archive_get_with_http_info(opts)
      return data
    end
    ...
    def v1_categories_archive_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CategoriesApi.v1_categories_archive_get ..."
      end
      # resource path
      local_var_path = "/v1/categories/archive"
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#v1_categories_archive_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def v1_categories_id_patch(id, json_patch_document, opts = {})
      v1_categories_id_patch_with_http_info(id, json_patch_document, opts)
      return nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_categories_id_patch_with_http_info(id, json_patch_document, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CategoriesApi.v1_categories_id_patch ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CategoriesApi.v1_categories_id_patch"
      end
      ...
      if @api_client.config.client_side_validation && json_patch_document.nil?
        fail ArgumentError, "Missing the required parameter 'json_patch_document' when calling CategoriesApi.v1_categories_id_patch"
      end
      # resource path
      local_var_path = "/v1/categories/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path,
        ...
        :auth_names => auth_names)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CategoriesApi#v1_categories_id_patch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @return [nil]
    def v1_categories_id_put(id, opts = {})
      v1_categories_id_put_with_http_info(id, opts)
      return nil
    end
    ...
    # @option opts [Category] :category The category to be updated.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_categories_id_put_with_http_info(id, opts = {})
      if @api_client.config.debugging
    ...
    # @return [nil]
    def v1_categories_post(opts = {})
      v1_categories_post_with_http_info(opts)
      return nil
    end
    ...
    # @option opts [Category] :category The category to be added.
    # @return [Array<(nil, Fixnum, Hash)>] nil, response status code and response headers
    def v1_categories_post_with_http_info(opts = {})
      if @api_client.config.debugging
